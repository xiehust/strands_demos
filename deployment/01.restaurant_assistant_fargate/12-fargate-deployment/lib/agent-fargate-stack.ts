  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    taskRole.addToPolicy(
      new iam.PolicyStatement({
        ...
        resources: ["arn:aws:bedrock:us-west-2:434444145045:knowledge-base/HRZGIQ6MVD"],
      }),
    );
    ...
    taskRole.addToPolicy(
      new iam.PolicyStatement({
        ...
        resources: ["arn:aws:dynamodb:us-west-2:434444145045:table/restaurant-assistant-bookings",
        "arn:aws:dynamodb:us-west-2:434444145045:table/restaurant-assistant-sessions"],
      }),
    );
    ...
    taskRole.addToPolicy(
      new iam.PolicyStatement({
        ...
        resources: ["arn:aws:ssm:us-west-2:434444145045:parameter/restaurant-assistant-table-name"],
      }),
    );
